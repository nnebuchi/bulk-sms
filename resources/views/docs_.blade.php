...
<body>
    ...
    <div class="header-content-wrapper">
        ...
        <nav id="sidebar-nav" class="fixed top-0 left-0 h-full w-64 bg-white border-r border-gray-200 p-6 z-40 hidden lg:block">
            <h2 class="text-2xl font-extrabold text-blue-600 mb-8 mt-2"><a href="#">Back to APP</a></h2>
            <ul class="space-y-4">
                <li><a onclick="smoothScroll('auth-section')" href="#auth-section" class="nav-link block p-2 rounded-lg text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition duration-150">Authentication</a></li>
                <li><a onclick="smoothScroll('send-sms-section')" href="#send-sms-section" class="nav-link block p-2 rounded-lg text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition duration-150">1. Send SMS Message</a></li>
                <li><a onclick="smoothScroll('balance-section')" href="#balance-section" class="nav-link block p-2 rounded-lg text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition duration-150">2. Check Unit Balance</a></li>
                <li><a onclick="smoothScroll('status-section')" href="#status-section" class="nav-link block p-2 rounded-lg text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition duration-150">3. Check Message Status</a></li>
            </ul>
        </nav>
        ...
        <main class="main-content flex-grow lg:ml-64 pt-20 lg:pt-8 p-6 sm:p-10">
            <h1 class="hidden lg:block text-4xl font-extrabold text-gray-900 mb-10">Reseller SMS API Documentation</h1>
            ...
            <section id="auth-section" class="mb-16 pt-4">
                ...
                <div class="bg-blue-50 p-4 rounded-lg mb-6 border-l-4 border-blue-500 flex justify-between items-center">
                    <span id="api-key-value" class="font-mono text-blue-800 select-all">YOUR_API_KEY_HERE</span>
            ...
            <section id="send-sms-section" class="mb-16 pt-4">
                ...
                <h3 class="text-xl font-semibold text-gray-700 mb-4">Example Request (cURL)</h3>
                <div class="code-block p-4 rounded-lg text-white mb-6 relative">
                    <pre id="curl-send-request" class="overflow-x-auto text-sm font-mono whitespace-pre-wrap">$ curl -X POST "https://yourdomain.com/api/sms/send" \
    ...
    "required_units": 12
            ...
            <section id="balance-section" class="mb-16 pt-4">
                ...
                <h3 class="text-xl font-semibold text-gray-700 mb-4">Example Request (cURL)</h3>
                <div class="code-block p-4 rounded-lg text-white mb-6 relative">
                    <pre id="curl-balance-request" class="overflow-x-auto text-sm font-mono whitespace-pre-wrap">$ curl -X GET "https://yourdomain.com/api/user/balance" \
    ...
    "available_units": 198.00
            ...
            <section id="status-section" class="mb-16 pt-4">
                ...
                <h3 class="text-xl font-semibold text-gray-700 mb-4">Example Request (cURL)</h3>
                <div class="code-block p-4 rounded-lg text-white mb-6 relative">
                    <pre id="curl-status-request" class="overflow-x-auto text-sm font-mono whitespace-pre-wrap">$ curl -X GET "https://yourdomain.com/api/sms/status/145" \
     -H "X-Api-Key: YOUR_API_KEY_HERE"</pre>
    ...
    <script>
        ...
        // Attach copyToClipboard to window object so it can be called from onclick attributes
