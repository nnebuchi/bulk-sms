    ...
    <div class="border border-gray-200 rounded-md overflow-x-auto">
          ...
          <tr
            ...
            <td class="mobilemd:px-4 px-2 py-4">
              <div  class="font-medium text-skzdark-100 space-x-4"
                ...
                <button class="cursor-pointer">
                  <span class="fa fa-edit text-skzdark-100"></span>
                </button>


                <button class="cursor-pointer">
                  <span
                    class="fa fa-trash-can text-skzdark-100"  id="delete-btn-{{ $message->slug }}" slug="{{ $message->slug }}"></span></button
              ></div>
            </td>
          </tr>
            ...
            <div
                ...
                <div class="border-t border-gray-200 pt-3">
                    ...
                    <span>Created at {{ date('d.m.Y', strtotime($message->created_at)) }}</span>
                    <span
                        >Status:
                        <span
      ...
      <nav
        ...
        <span
          ...
          >Showing
          <span class="font-semibold text-gray-900">{{ $messages->firstItem() }}–{{ $messages->lastItem() }}</span>
          of
          <span class="font-semibold text-gray-900">{{ $messages->total() }}</span></span
        >
