...
<div class="mx-auto">
    ...
    <div class="bg-white shadow-lg rounded-xl p-4 tabletmd:p-8 sm:p-6">
        ...
        <div class="space-y-6 mb-8">
            <!-- API Key Display -->
            <div class="relative  w-full api-key-container">
            ...
            <!-- Guidance Note -->
            <div class="p-4 mt-6 bg-yellow-50 border-l-4 border-yellow-500 rounded-lg ">
    ...
    generateKeyButton.addEventListener('click', (e) => {
        ...
        const modalHtml = `
            <div id="confirm-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div class="bg-white rounded-xl shadow-2xl p-6 w-7/12">
